...
//   console.log(`Назва продукту ${name}. Ціна за кг: ${price}.
//     К-ть кг на складі: ${quantity}`);
// }
...
//   console.log(
//     `Загальна вартість всіх продуктів ${name} на складі становить ${
//       price * quantity
//     } грн.`
//   );
// }
...
// const onSuccess = message => console.log(`✅ Success! ${message}`);

// const onError = message => console.error(`❌ Error! ${message}`);

// console.table(acount);
// acount.withdraw(600, onSuccess, onError);
// acount.withdraw(1200, onSuccess, onError);
// acount.withdraw(950, onSuccess, onError);
// acount.deposit(0, onSuccess, onError);
// acount.deposit(10100, onSuccess, onError);
// acount.deposit(600, onSuccess, onError);
...
// 2. перебір масиву
//     2.1 викликати колбек функцію на поточному елементі масиву
//     2.2 результат колбек функції запушити у новий масив
